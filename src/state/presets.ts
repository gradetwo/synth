...
export const FACTORY_PRESETS: Preset[] = [
  ...
  preset('hyperpop', 'Hyperpop Lead · 超流行主音', 'HYPERPOP', 'LEAD', 'saw', {
    ...
    [P.OSC1_WAVE]: 2, [P.OSC1_LEVEL]: 0.62, [P.OSC1_UNISON]: 3, [P.OSC1_SPREAD]: 0.4,
    [P.OSC2_ON]: 1, [P.OSC2_WAVE]: 4, [P.OSC2_PITCH]: 12, [P.OSC2_DETUNE]: -8, [P.OSC2_LEVEL]: 0.3,
    [P.FILTER_CUTOFF]: 9000, [P.FILTER_RES]: 0.25, [P.FILTER_DRIVE]: 0.35, [P.FILTER_ENV_AMT]: 0.45,
    [P.LFO_ON]: 0,
    [P.FX_CHORUS_ON]: 1, [P.FX_CHORUS_MIX]: 0.3,
    [P.FX_REVERB_SIZE]: 0.3, [P.FX_REVERB_MIX]: 0.18,
  }),
  preset('futurechord', 'Future Chord · 未来和弦', 'FUTURE BASS', 'PAD', 'saw', {
    ...envP(0.03, 0.6, 0.7, 0.5),
    [P.OSC1_WAVE]: 2, [P.OSC1_LEVEL]: 0.5, [P.OSC1_UNISON]: 5, [P.OSC1_SPREAD]: 0.55,
    [P.OSC2_ON]: 1, [P.OSC2_WAVE]: 3, [P.OSC2_PITCH]: 12, [P.OSC2_LEVEL]: 0.22,
    [P.FILTER_CUTOFF]: 5200, [P.FILTER_RES]: 0.18, [P.FILTER_DRIVE]: 0.2, [P.FILTER_ENV_AMT]: 0.3,
    [P.LFO_ON]: 1, [P.LFO_TARGET]: 1, [P.LFO_DEPTH]: 0.12, [P.LFO_RATE]: 4.5,
    [P.FX_CHORUS_ON]: 1, [P.FX_CHORUS_MIX]: 0.35,
    [P.FX_REVERB_SIZE]: 0.55, [P.FX_REVERB_MIX]: 0.3,
  }),
  preset('synthwave', 'Synthwave Bass · 合成器波浪贝斯', 'SYNTHWAVE', 'BASS', 'saw', {
    ...envP(0.004, 0.3, 0.75, 0.12),
    [P.OSC1_WAVE]: 2, [P.OSC1_LEVEL]: 0.7, [P.OSC1_UNISON]: 2, [P.OSC1_SPREAD]: 0.2,
    [P.OSC2_ON]: 1, [P.OSC2_WAVE]: 2, [P.OSC2_PITCH]: -12, [P.OSC2_DETUNE]: 6, [P.OSC2_LEVEL]: 0.25,
    [P.FILTER_CUTOFF]: 1200, [P.FILTER_RES]: 0.35, [P.FILTER_DRIVE]: 0.3, [P.FILTER_ENV_AMT]: 0.4,
    [P.FILTER_ENV_DECAY]: 0.18,
    [P.LFO_ON]: 0, [P.VOICE_MODE]: 1, [P.GLIDE]: 0.06,
    [P.FX_REVERB_ON]: 0,
  }),
  preset('phonk', 'Phonk Cowbell · 暗黑牛铃', 'PHONK', 'FX', 'square', {
    ...envP(0.001, 0.12, 0.0, 0.08),
    [P.OSC1_WAVE]: 0, [P.OSC1_PITCH]: 24, [P.OSC1_LEVEL]: 0.5,
    [P.OSC2_ON]: 1, [P.OSC2_WAVE]: 0, [P.OSC2_PITCH]: 31, [P.OSC2_LEVEL]: 0.42,
    [P.FILTER_TYPE]: 4, [P.FILTER_CUTOFF]: 2400, [P.FILTER_RES]: 0.72,
    [P.FILTER_ENV_AMT]: 0,
    [P.LFO_ON]: 0, [P.FX_REVERB_ON]: 0, [P.FX_DELAY_ON]: 0,
  }),
  preset('drill808', 'Drill 808 · 钻头低音', 'TRAP', 'BASS', 'sine', {
    ...envP(0.002, 1.1, 0.85, 0.6),
    [P.OSC1_WAVE]: 0, [P.OSC1_LEVEL]: 0.9,
    [P.OSC2_ON]: 0,
    [P.FILTER_CUTOFF]: 800, [P.FILTER_RES]: 0.05, [P.FILTER_DRIVE]: 0.4,
    [P.VOICE_MODE]: 1, [P.GLIDE]: 0.12,
    [P.LFO_ON]: 0, [P.FX_REVERB_ON]: 0, [P.FX_DELAY_ON]: 0,
  }),
  preset('ambient', 'Ambient Bloom · 氛围绽放', 'AMBIENT', 'PAD', 'triangle', {
    ...envP(1.6, 2.0, 0.85, 2.4),
    [P.OSC1_WAVE]: 1, [P.OSC1_LEVEL]: 0.55, [P.OSC1_UNISON]: 4, [P.OSC1_SPREAD]: 0.5,
    [P.OSC2_ON]: 1, [P.OSC2_WAVE]: 0, [P.OSC2_PITCH]: 12, [P.OSC2_DETUNE]: -4, [P.OSC2_LEVEL]: 0.22,
    [P.FILTER_CUTOFF]: 2600, [P.FILTER_RES]: 0.12, [P.FILTER_ENV_AMT]: 0.25,
    [P.LFO_ON]: 1, [P.LFO_TARGET]: 0, [P.LFO_DEPTH]: 0.25, [P.LFO_RATE]: 0.12,
    [P.FX_REVERB_SIZE]: 0.8, [P.FX_REVERB_MIX]: 0.42,
  }),
  preset('robotvoice', 'Robot Voice · 机器人声', 'EXPERIMENTAL', 'FX', 'saw', {
    ...envP(0.02, 0.3, 0.9, 0.2),
    [P.OSC1_WAVE]: 2, [P.OSC1_LEVEL]: 0.6, [P.OSC1_UNISON]: 2, [P.OSC1_SPREAD]: 0.15,
    [P.OSC2_ON]: 1, [P.OSC2_WAVE]: 5, [P.OSC2_LEVEL]: 0.15,
    [P.FILTER_TYPE]: 5, [P.FILTER_CUTOFF]: 700, [P.FILTER_RES]: 0.45,
    [P.LFO_ON]: 1, [P.LFO_TARGET]: 0, [P.LFO_DEPTH]: 0.3, [P.LFO_RATE]: 5.2, [P.LFO_WAVE]: 2,
    [P.FX_REVERB_ON]: 0,
  }),
  preset('chiplead', 'Chiptune Lead · 芯片主音', 'CHIPTUNE', 'LEAD', 'square', {
    ...envP(0.001, 0.08, 0.7, 0.05),
    [P.OSC1_WAVE]: 4, [P.OSC1_PW]: 0.5, [P.OSC1_LEVEL]: 0.6,
    [P.OSC2_ON]: 1, [P.OSC2_WAVE]: 3, [P.OSC2_PITCH]: 12, [P.OSC2_LEVEL]: 0.18,
    [P.FILTER_CUTOFF]: 15000, [P.FILTER_RES]: 0,
    [P.LFO_ON]: 0,
    [P.FX_DELAY_ON]: 1, [P.FX_DELAY_MIX]: 0.22, [P.FX_DELAY_SYNC]: 1,
    [P.FX_REVERB_ON]: 0,
  }),
  preset('crystalglass', 'Crystal Glass · 水晶玻璃', 'CINEMATIC', 'KEYS', 'sine', {
    ...envP(0.002, 0.9, 0.25, 1.2),
    [P.OSC1_WAVE]: 0, [P.OSC1_LEVEL]: 0.6,
    [P.OSC2_ON]: 1, [P.OSC2_WAVE]: 0, [P.OSC2_PITCH]: 19, [P.OSC2_DETUNE]: 4, [P.OSC2_LEVEL]: 0.3,
    [P.FILTER_CUTOFF]: 8000, [P.FILTER_RES]: 0.08, [P.FILTER_ENV_AMT]: 0.3,
    [P.LFO_ON]: 0,
    [P.FX_CHORUS_ON]: 1, [P.FX_CHORUS_MIX]: 0.25,
    [P.FX_REVERB_SIZE]: 0.6, [P.FX_REVERB_MIX]: 0.34,
  }),
  preset('wobblebass', 'Wobble Bass · 摇摆低音', 'DUBSTEP', 'BASS', 'saw', {
    ...envP(0.004, 0.4, 0.9, 0.15),
    [P.OSC1_WAVE]: 2, [P.OSC1_LEVEL]: 0.75, [P.OSC1_UNISON]: 2, [P.OSC1_SPREAD]: 0.25,
    [P.OSC2_ON]: 0,
    [P.FILTER_TYPE]: 1, [P.FILTER_CUTOFF]: 900, [P.FILTER_RES]: 0.6, [P.FILTER_DRIVE]: 0.45,
    [P.LFO_ON]: 1, [P.LFO_TARGET]: 0, [P.LFO_DEPTH]: 0.5, [P.LFO_RATE]: 3.0, [P.LFO_WAVE]: 1,
    [P.FX_DRIVE_ON]: 1, [P.FX_DRIVE_AMT]: 0.35, [P.FX_DRIVE_MIX]: 0.4,
    [P.FX_REVERB_ON]: 0,
  }),
